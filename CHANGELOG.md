...
- **High Wick Warning Toggle**: Added `EnableHighWickWarning` to `RiskControlConfig` (default: `true`). Allows users to toggle the `[HIGH WICK ⚠️]` warning injected into the AI's market data prompt.
